...
START_TIME="2026-03-11T16:45:00.000Z"
END_TIME="2026-03-11T17:32:00.000Z"
STEP="15s"


# ================= ESTRAZIONE =================
echo "Inizio estrazione dati Demo 2..."
mkdir -p test-2-3 # test-2-3
cd test-2-3
...
NODE_STD="el-2-nethermind-lighthouse"
...
KURTOSIS_PROMETHEUS_URL="http://127.0.0.1:33208/api/v1/query_range"

# ================= QUERY PROMQL =================
declare -A QUERIES_KURTOSIS=(
    # TEMPI DI ESECUZIONE / VERIFICA (Per il Grafico a Barre O(N) vs O(1))
    ["time_std"]="nethermind_new_payload_execution_time{job='$NODE_STD'}"
    ["time_zk"]="nethermind_new_payload_execution_time{job='$NODE_ZK'}"
)
